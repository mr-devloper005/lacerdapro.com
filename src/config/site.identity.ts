export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'lacerdapro',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Lacerdapro',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'lacerdapro.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://lacerdapro.com',
